...
var mouseController = {
  ...
  leftClick: function (event) {
    ...
    if (Button.callback == null) {
      ...
      var selectedOne = Game.getSelectedOne(
        clickX + Map.offsetX,
        clickY + Map.offsetY
      );
  ...
  rightClick: function (event, unlock) {
    ...
    var selectedEnemy = Game.getSelectedOne(
      clickX + Map.offsetX,
      clickY + Map.offsetY,
      true
    ); //isEnemy
        ...
        if (chara.selected) {
          ...
          //Move mode
            ...
            if (Button.callback == 'patrol') {
              ...
              chara.destination.next = {
                x: chara.posX(),
                y: chara.posY(),
                next: chara.destination,
              };
            }
          }
        }
  ...
  toControlAll: function () {
    ...
    $('#frontCanvas')[0].onmousemove = function (event) {
      ...
      if (mouseController.down) {
        ...
        if (
          Math.abs(clickX - mouseController.startPoint.x) > 5 &&
