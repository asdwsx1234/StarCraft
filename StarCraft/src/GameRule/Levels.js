...
import BuildingStore from '../Characters/BuildingStore';
...
var Levels = [
  ...
  },
  {
    ...
    load: function () {
      ...
      //Add buildings
      //Zerg buildings
      new BuildingStore.ZergBuilding.Hatchery({ x: 0, y: 520 });
      new BuildingStore.ZergBuilding.Lair({ x: 0, y: 670 });
      new BuildingStore.ZergBuilding.Hive({ x: 0, y: 820 });
      new BuildingStore.ZergBuilding.CreepColony({ x: 150, y: 520 });
      new BuildingStore.ZergBuilding.SunkenColony({ x: 150, y: 670 });
      new BuildingStore.ZergBuilding.SporeColony({ x: 150, y: 820, isEnemy: true });
      new BuildingStore.ZergBuilding.Extractor({ x: 300, y: 520 });
      new BuildingStore.ZergBuilding.SpawningPool({ x: 300, y: 670 });
      new BuildingStore.ZergBuilding.EvolutionChamber({ x: 300, y: 820 });
      new BuildingStore.ZergBuilding.HydraliskDen({ x: 450, y: 520 });
      new BuildingStore.ZergBuilding.Spire({ x: 450, y: 670 });
      new BuildingStore.ZergBuilding.GreaterSpire({ x: 450, y: 820 });
      new BuildingStore.ZergBuilding.QueenNest({ x: 600, y: 520 });
      new BuildingStore.ZergBuilding.NydusCanal({ x: 600, y: 670 });
      new BuildingStore.ZergBuilding.UltraliskCavern({ x: 600, y: 820 });
      new BuildingStore.ZergBuilding.DefilerMound({ x: 750, y: 520 });
      new BuildingStore.ZergBuilding.InfestedBase({ x: 750, y: 670 });
      new BuildingStore.ZergBuilding.OvermindI({ x: 750, y: 820 });
      new BuildingStore.ZergBuilding.OvermindII({ x: 900, y: 520 });
      //Terran buildings
      new BuildingStore.TerranBuilding.CommandCenter({ x: 0, y: 1020 });
      new BuildingStore.TerranBuilding.SupplyDepot({ x: 0, y: 1170, isEnemy: true });
      new BuildingStore.TerranBuilding.Refinery({ x: 0, y: 1320 });
      new BuildingStore.TerranBuilding.Barracks({ x: 150, y: 1020 });
      new BuildingStore.TerranBuilding.EngineeringBay({ x: 150, y: 1170 });
      new BuildingStore.TerranBuilding.MissileTurret({ x: 150, y: 1320 });
      new BuildingStore.TerranBuilding.Academy({ x: 300, y: 1020 });
      new BuildingStore.TerranBuilding.Bunker({ x: 300, y: 1170 });
      new BuildingStore.TerranBuilding.Factory({ x: 300, y: 1320 });
      new BuildingStore.TerranBuilding.Starport({ x: 450, y: 1020 });
      new BuildingStore.TerranBuilding.ScienceFacility({ x: 450, y: 1170 });
      new BuildingStore.TerranBuilding.Armory({ x: 450, y: 1320 });
      new BuildingStore.TerranBuilding.ComstatStation({ x: 600, y: 1020 });
      new BuildingStore.TerranBuilding.NuclearSilo({ x: 600, y: 1170 });
      new BuildingStore.TerranBuilding.MachineShop({ x: 600, y: 1320 });
      new BuildingStore.TerranBuilding.ControlTower({ x: 750, y: 1020 });
      new BuildingStore.TerranBuilding.PhysicsLab({ x: 750, y: 1170 });
      new BuildingStore.TerranBuilding.ConvertOps({ x: 750, y: 1320 });
      new BuildingStore.TerranBuilding.CrashCruiser({ x: 900, y: 1020 });
      new BuildingStore.TerranBuilding.BigCannon({ x: 900, y: 1170 });
      //Protoss buildings
      new BuildingStore.ProtossBuilding.Nexus({ x: 0, y: 20 });
      new BuildingStore.ProtossBuilding.Pylon({ x: 0, y: 170, isEnemy: true });
      new BuildingStore.ProtossBuilding.Assimilator({ x: 0, y: 320 });
      new BuildingStore.ProtossBuilding.Gateway({ x: 150, y: 20 });
      new BuildingStore.ProtossBuilding.Forge({ x: 150, y: 170 });
      new BuildingStore.ProtossBuilding.PhotonCannon({ x: 150, y: 320 });
      new BuildingStore.ProtossBuilding.CyberneticsCore({ x: 300, y: 20 });
      new BuildingStore.ProtossBuilding.ShieldBattery({ x: 300, y: 170 });
      new BuildingStore.ProtossBuilding.RoboticsFacility({ x: 300, y: 320 });
      new BuildingStore.ProtossBuilding.StarGate({ x: 450, y: 20 });
      new BuildingStore.ProtossBuilding.CitadelOfAdun({ x: 450, y: 170 });
      new BuildingStore.ProtossBuilding.RoboticsSupportBay({ x: 450, y: 320 });
      new BuildingStore.ProtossBuilding.FleetBeacon({ x: 600, y: 20 });
      new BuildingStore.ProtossBuilding.TemplarArchives({ x: 600, y: 170 });
      new BuildingStore.ProtossBuilding.Observatory({ x: 600, y: 320 });
      new BuildingStore.ProtossBuilding.ArbiterTribunal({ x: 750, y: 20 });
      new BuildingStore.ProtossBuilding.TeleportGate({ x: 750, y: 170 });
      new BuildingStore.ProtossBuilding.Pyramid({ x: 750, y: 320 });
      new BuildingStore.ProtossBuilding.TeleportPoint({ x: 900, y: 20 });
    },
  },
  {
    level: 8,
    ...
    load: function () {
      ...
      new BuildingStore.ZergBuilding.OvermindI({ x: 662, y: 3828 });
      new BuildingStore.ZergBuilding.OvermindII({ x: 300, y: 3694 });
      new BuildingStore.TerranBuilding.CrashCruiser({ x: 820, y: 3600 });
      new BuildingStore.TerranBuilding.BigCannon({ x: 260, y: 3560 });
      new BuildingStore.ProtossBuilding.Pyramid({ x: 560, y: 3690 });
      new BuildingStore.ProtossBuilding.TeleportGate({ x: 560, y: 3558 });
      new BuildingStore.ProtossBuilding.TeleportPoint({ x: 534, y: 3884 });
      ...
      //Zerg
      new BuildingStore.ZergBuilding.Hatchery({ x: 3470, y: 3720, isEnemy: true });
      new BuildingStore.ZergBuilding.Lair({ x: 3265, y: 3795, isEnemy: true });
      new BuildingStore.ZergBuilding.Hive({ x: 3650, y: 3700, isEnemy: true });
      new BuildingStore.ZergBuilding.CreepColony({
        x: 3488,
        y: 3552,
        isEnemy: true,
      });
      ...
      new BuildingStore.ZergBuilding.SunkenColony({
        x: 3328,
        y: 3552,
        isEnemy: true,
      });
      ...
      new BuildingStore.ZergBuilding.SporeColony({
        x: 3136,
        y: 3552,
        isEnemy: true,
      });
      new BuildingStore.ZergBuilding.Extractor({ x: 3420, y: 3800, isEnemy: true });
      new BuildingStore.ZergBuilding.SpawningPool({
        x: 3440,
        y: 3616,
        isEnemy: true,
      });
      new BuildingStore.ZergBuilding.EvolutionChamber({
        x: 3248,
        y: 3616,
        isEnemy: true,
      });
      new BuildingStore.ZergBuilding.HydraliskDen({
        x: 3344,
        y: 3616,
        isEnemy: true,
      });
      new BuildingStore.ZergBuilding.Spire({ x: 3744, y: 3552, isEnemy: true });
      new BuildingStore.ZergBuilding.GreaterSpire({
        x: 3808,
        y: 3616,
        isEnemy: true,
      });
      new BuildingStore.ZergBuilding.QueenNest({ x: 3728, y: 3616, isEnemy: true });
      new BuildingStore.ZergBuilding.NydusCanal({ x: 3200, y: 3552, isEnemy: true });
      new BuildingStore.ZergBuilding.UltraliskCavern({
        x: 3824,
        y: 3520,
        isEnemy: true,
      });
      new BuildingStore.ZergBuilding.DefilerMound({
        x: 3104,
        y: 3776,
        isEnemy: true,
      });
      new BuildingStore.ZergBuilding.InfestedBase({
        x: 3264,
        y: 3920,
        isEnemy: true,
      });
      ...
      //Terran
      new BuildingStore.TerranBuilding.CommandCenter({
        x: 320,
        y: 180,
        isEnemy: true,
      });
      new BuildingStore.TerranBuilding.ComstatStation({
        x: 434,
        y: 220,
        isEnemy: true,
      });
      new BuildingStore.TerranBuilding.SupplyDepot({
        x: 368,
        y: 416,
        isEnemy: true,
      });
      ...
      new BuildingStore.TerranBuilding.Refinery({ x: 96, y: 246, isEnemy: true });
      new BuildingStore.TerranBuilding.Barracks({ x: 576, y: 432, isEnemy: true });
      new BuildingStore.TerranBuilding.EngineeringBay({
        x: 576,
        y: 336,
        isEnemy: true,
      });
      new BuildingStore.TerranBuilding.MissileTurret({
        x: 384,
        y: 576,
        isEnemy: true,
      });
      ...
      new BuildingStore.TerranBuilding.Academy({ x: 272, y: 416, isEnemy: true });
      new BuildingStore.TerranBuilding.Bunker({ x: 636, y: 556, isEnemy: true });
      new BuildingStore.TerranBuilding.Bunker({ x: 764, y: 460, isEnemy: true });
      new BuildingStore.TerranBuilding.Factory({ x: 732, y: 220, isEnemy: true });
      new BuildingStore.TerranBuilding.MachineShop({
        x: 832,
        y: 256,
        isEnemy: true,
      });
      new BuildingStore.TerranBuilding.Starport({ x: 732, y: 316, isEnemy: true });
      new BuildingStore.TerranBuilding.ControlTower({
        x: 832,
        y: 352,
        isEnemy: true,
      });
      new BuildingStore.TerranBuilding.ScienceFacility({
        x: 60,
        y: 390,
        isEnemy: true,
      });
      new BuildingStore.TerranBuilding.PhysicsLab({ x: 160, y: 416, isEnemy: true });
      new BuildingStore.TerranBuilding.Armory({ x: 272, y: 480, isEnemy: true });
      ...
      //Protoss
      new BuildingStore.ProtossBuilding.Nexus({ x: 3614, y: 222, isEnemy: true });
      new BuildingStore.ProtossBuilding.Pylon({ x: 3296, y: 512, isEnemy: true });
      new BuildingStore.ProtossBuilding.Pylon({ x: 3424, y: 288, isEnemy: true });
      new BuildingStore.ProtossBuilding.Pylon({ x: 3648, y: 512, isEnemy: true });
      new BuildingStore.ProtossBuilding.Assimilator({
        x: 3582,
        y: 86,
        isEnemy: true,
      });
      new BuildingStore.ProtossBuilding.Gateway({ x: 3648, y: 624, isEnemy: true });
      new BuildingStore.ProtossBuilding.Forge({ x: 3504, y: 448, isEnemy: true });
      new BuildingStore.ProtossBuilding.PhotonCannon({
        x: 3200,
        y: 448,
        isEnemy: true,
      });
      ...
      new BuildingStore.ProtossBuilding.CyberneticsCore({
        x: 3760,
        y: 448,
        isEnemy: true,
      });
      new BuildingStore.ProtossBuilding.ShieldBattery({
        x: 3728,
        y: 544,
        isEnemy: true,
      });
      new BuildingStore.ProtossBuilding.RoboticsFacility({
        x: 3344,
        y: 224,
        isEnemy: true,
      });
      new BuildingStore.ProtossBuilding.StarGate({ x: 3232, y: 304, isEnemy: true });
      new BuildingStore.ProtossBuilding.CitadelOfAdun({
        x: 3632,
        y: 408,
        isEnemy: true,
      });
      new BuildingStore.ProtossBuilding.RoboticsSupportBay({
        x: 3344,
        y: 384,
        isEnemy: true,
      });
      new BuildingStore.ProtossBuilding.FleetBeacon({
        x: 3438,
        y: 182,
        isEnemy: true,
      });
      new BuildingStore.ProtossBuilding.TemplarArchives({
        x: 3504,
        y: 544,
        isEnemy: true,
      });
      new BuildingStore.ProtossBuilding.Observatory({
        x: 3504,
        y: 320,
        isEnemy: true,
      });
      new BuildingStore.ProtossBuilding.ArbiterTribunal({
        x: 3216,
        y: 192,
        isEnemy: true,
      });
  ...
  },
  {
    ...
    load: function () {
      ...
      var Pyramid = new BuildingStore.ProtossBuilding.Pyramid({ x: 1450, y: 1480 });
      for (var N = 0; N < 6; N++) {
