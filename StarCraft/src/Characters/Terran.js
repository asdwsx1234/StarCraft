...
Terran.SCV = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.SmallExplode,
    attackEffect: BurstStore.SCVSpark,
    isFlying: false,
    attackLimit: 'ground',
    unitType: Unit.SMALL,
...
Terran.Marine = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    attackEffect: BurstStore.ShootSpark,
    isFlying: false,
    unitType: Unit.SMALL,
    attackType: AttackableUnit.NORMAL_ATTACK,
    recover: Building.TerranBuilding.prototype.recover,
...
Terran.Medic = Unit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.MedicDeath,
    isFlying: false,
    unitType: Unit.SMALL,
    recover: Building.TerranBuilding.prototype.recover,
    cost: {
...
Terran.Vulture = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.MiddleExplode,
    isFlying: false,
    attackLimit: 'ground',
...
Terran.Tank = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.BigExplode,
    attackEffect: BurstStore.FireSpark,
    isFlying: false,
    attackLimit: 'ground',
    unitType: Unit.BIG,
