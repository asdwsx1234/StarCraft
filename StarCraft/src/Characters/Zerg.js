...
Zerg.Drone = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.DroneDeath,
    isFlying: false,
    attackLimit: 'ground',
    unitType: Unit.SMALL,
...
Zerg.Zergling = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.ZerglingDeath,
    isFlying: false,
    attackLimit: 'ground',
    unitType: Unit.SMALL,
    attackType: AttackableUnit.NORMAL_ATTACK,
...
Zerg.Hydralisk = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.HydraliskDeath,
    isFlying: false,
  ...
  prototypePlus: {
    ...
    imgPos: {
      ...
      burrow: {
        ...
        top: [
          [
            482, -1, 482, 482, 482, 482, 482, 482, 482, 482, 482, 482, 482, 482,
            482,
          ],
          [
            482, -1, 482, 482, 482, 482, 482, 482, 482, 482, 482, 482, 482, 482,
    ...
    dieEffect: BurstStore.LurkerDeath,
    isFlying: false,
    attackLimit: 'ground',
    unitType: Unit.MIDDLE,
    attackType: AttackableUnit.NORMAL_ATTACK,
...
Zerg.Scourge = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.SmallZergFlyingDeath,
    attackEffect: BurstStore.ScourgeBomb,
    isFlying: true,
    attackLimit: 'flying',
    suicide: true,
    unitType: Unit.SMALL,
...
Zerg.Broodling = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.BroodlingDeath,
    isFlying: false,
    attackLimit: 'ground',
    unitType: Unit.SMALL,
    recover: Building.ZergBuilding.prototype.recover,
...
Zerg.Ultralisk = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.UltraliskDeath,
    isFlying: false,
    attackLimit: 'ground',
    unitType: Unit.BIG,
    attackType: AttackableUnit.NORMAL_ATTACK,
...
Zerg.Defiler = Unit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.DefilerDeath,
    isFlying: false,
    unitType: Unit.MIDDLE,
    recover: Building.ZergBuilding.prototype.recover,
    cost: {
...
Zerg.InfestedTerran = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.HumanDeath,
    attackEffect: BurstStore.InfestedBomb,
    isFlying: false,
    attackLimit: 'ground',
    suicide: true,
    unitType: Unit.SMALL,
...
Zerg.Larva = Unit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.LarvaDeath,
    unitType: Unit.SMALL,
    isFlying: false,
    recover: Building.ZergBuilding.prototype.recover,
    upgrade: ['EvolveCarapace'],
