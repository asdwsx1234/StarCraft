...
Neutral.Ragnasaur = Unit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.RagnasaurDeath,
    isFlying: false,
    unitType: Unit.SMALL,
...
Neutral.Rhynsdon = Unit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.RhynsdonDeath,
    isFlying: false,
    unitType: Unit.SMALL,
    recover: Building.ZergBuilding.prototype.recover,
    //Override
...
Neutral.Ursadon = Unit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.UrsadonDeath,
    isFlying: false,
    unitType: Unit.SMALL,
    recover: Building.ZergBuilding.prototype.recover,
    //Override
...
Neutral.Bengalaas = Unit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.BengalaasDeath,
    isFlying: false,
    unitType: Unit.SMALL,
    recover: Building.ZergBuilding.prototype.recover,
    //Override
...
Neutral.Scantid = Unit.extends({
  ...
  prototypePlus: {
    ...
    imgPos: {
      moving: {
        left: [
          ...
          [
            1208, 1208, 1208, 1208, 1208, 1208, 1208, 1208, 1208, 1208, 1208,
            1208,
          ],
          [
    ...
    dieEffect: BurstStore.ScantidDeath,
    isFlying: false,
    unitType: Unit.SMALL,
    recover: Building.ZergBuilding.prototype.recover,
    //Override
...
Neutral.Kakaru = Unit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.KakaruDeath,
    isFlying: true,
    unitType: Unit.SMALL,
    recover: Building.ZergBuilding.prototype.recover,
    //Override
