...
var Bullets = Gobj.extends({
  constructorPlus: function (props) {
    ...
    //Makes below initial keep the same
    var targetX =
      this.target instanceof Gobj ? this.target.posX() : this.target.x;
    var targetY =
      this.target instanceof Gobj ? this.target.posY() : this.target.y;
...
Bullets.Darts = Bullets.extends({
  ...
  prototypePlus: {
    //Add basic unit info
    name: 'BurstStore', //Source img inside Mutalisk.png
