...
Protoss.Probe = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.SmallBlueExplode,
    attackEffect: BurstStore.ProbeSpark,
    isFlying: false,
    attackLimit: 'ground',
    unitType: Unit.SMALL,
...
Protoss.Zealot = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.SmallProtossDeath,
    isFlying: false,
    attackLimit: 'ground',
    unitType: Unit.SMALL,
    attackType: AttackableUnit.NORMAL_ATTACK,
...
Protoss.Dragoon = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.DragoonDeath,
    isFlying: false,
    unitType: Unit.BIG,
...
Protoss.Templar = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.TemplarDeath,
    attackEffect: BurstStore.FireSpark,
    isFlying: false,
    unitType: Unit.SMALL,
...
Protoss.Archon = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    attackRange: 70,
    attackInterval: 1000,
    attackEffect: BurstStore.ArchonBurst,
...
Protoss.Shuttle = Unit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.MiddleBlueExplode,
    isFlying: true,
    unitType: Unit.BIG,
    recover: Building.ProtossBuilding.prototype.recover,
    cost: {
    ...
    items: {
      7: {
        ...
        condition: function () {
          ...
          return (
            Game.selectedUnit.scarabNum <
            Game.selectedUnit.get('scarabCapacity')
          );
        },
      },
    },
...
Protoss.Scout = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    attackMode: {
      ...
      ground: {
        attackRange: 105,
        attackEffect: BurstStore.BlueShootSpark,
        attackInterval: 2200,
        damage: 8,
        attackType: AttackableUnit.NORMAL_ATTACK,
      },
    ...
    items: {
      7: {
        ...
        condition: function () {
          ...
          return (
            Game.selectedUnit.continuousAttack.count <
            Game.selectedUnit.get('interceptorCapacity')
          );
        },
      },
    },
...
Protoss.Corsair = AttackableUnit.extends({
  ...
  prototypePlus: {
    ...
    dieEffect: BurstStore.MiddleBlueExplode,
    attackEffect: BurstStore.CorsairCloud,
    isFlying: true,
    attackLimit: 'flying',
